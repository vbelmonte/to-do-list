...
/* harmony import */ var _task_subject__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./task-subject */ "./src/task-subject.js");
...
function assignFormMethod(form, type, projectObj) {
  if (type === 'Task') {
    ...
    form.onsubmit = function (event) {
      (0,_form_processor__WEBPACK_IMPORTED_MODULE_1__.processModifyTaskForm)(event, taskObj);
      clearFormValues();
      (0,_templates__WEBPACK_IMPORTED_MODULE_0__.closeForm)(event);
    };
  } else {
    form.onsubmit = function (event) {
      (0,_form_processor__WEBPACK_IMPORTED_MODULE_1__.processModifyProjectForm)(event, projObj);
      clearFormValues();
      (0,_templates__WEBPACK_IMPORTED_MODULE_0__.closeForm)(event);
    };
  }
...
function createDueDate(dueDate) {
  const dueDateDiv = document.createElement('div');
  const taskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dueDate), 'MM/dd/yyyy');
