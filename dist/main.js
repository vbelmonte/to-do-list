...
function loadInbox() {
  ...
  const moduleContainerDiv = (0,_templates__WEBPACK_IMPORTED_MODULE_0__.createModuleContainer)('my-tasks');
...
function createTaskIconsDiv(colorClass, taskObj) {
  ...
  editIconDiv.addEventListener('click', () => {
    ...
    const editModal = (0,_form_template__WEBPACK_IMPORTED_MODULE_1__.createEditForm)(`Edit ${taskObj.classname}`, taskObj);
